...
namespace Analyzers
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(AddAllowAnonymousCodeFixProvider)), Shared]
    public class AddAllowAnonymousCodeFixProvider : CodeFixProvider
    {
