...
properties {
    ...
    $unitTestAssembly = "Analyzers.Test.dll"
...
task Test -depends Compile {
    ...
    exec {
        & $nunitPath\nunit3-console.exe $test_dir\$unitTestAssembly $script:teamcityoutput --workers=1 --noheader --result="$build_dir\TestResult.xml"`;format=nunit3
    }
}
